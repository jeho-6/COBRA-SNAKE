...
void MX_FDCAN1_Init(void)
{
  ...
  sFilterConfig.FilterIndex = 0;                      // 使用第0号过滤器
  sFilterConfig.FilterType = FDCAN_FILTER_MASK;       // 掩码过滤器
  sFilterConfig.FilterConfig = FDCAN_FILTER_TO_RXFIFO0; // 接收匹配帧放入FIFO0
  sFilterConfig.FilterID1 = 0x000;                    // 过滤器 ID
  sFilterConfig.FilterID2 = 0x000;                    // 掩码 = 0 -> 匹配所有
